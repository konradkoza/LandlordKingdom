...
import pl.lodz.p.it.landlordkingdom.mok.dto.GetActiveLocalsFilterRequest;
import pl.lodz.p.it.landlordkingdom.mol.dto.*;
import pl.lodz.p.it.landlordkingdom.mol.mappers.AddressMapper;
import pl.lodz.p.it.landlordkingdom.mol.mappers.LocalMapper;
import pl.lodz.p.it.landlordkingdom.mol.mappers.ReportMapper;
import pl.lodz.p.it.landlordkingdom.mol.services.LocalService;
import pl.lodz.p.it.landlordkingdom.util.Signer;
import pl.lodz.p.it.landlordkingdom.mol.services.ReportService;
